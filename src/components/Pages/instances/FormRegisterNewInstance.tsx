...
import { faLock, faCopy, faHdd, faLink } from "@fortawesome/free-solid-svg-icons";
...
const FormRegisterNewInstance: React.FC<FormRegisterNewInstanceProps> = ({ dict }) => {
  ...
  return (
    <Form>
        <Row>
            <Col md={12}>
                <h5>1.{' '+dict.pages.instances.register.navTabs.webInstanceData}</h5>
                <hr />
            </Col>
        </Row>
        <Row className='mb-3'>
        ...
        <Row>
            <Col md={12}>
                <h5>2.{' '+dict.pages.instances.register.navTabs.configs}</h5>
                <hr />
            </Col>
        </Row>
        <Row>
